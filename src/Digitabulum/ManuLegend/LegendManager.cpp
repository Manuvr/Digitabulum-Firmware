...
LegendManager::LegendManager() {
  ...
  _preformed_read_a.callback = (SPIDeviceWithRegisters*) this;
  ...
  _preformed_read_g.callback = (SPIDeviceWithRegisters*) this;
  ...
  _preformed_fifo_read.callback = (SPIDeviceWithRegisters*) this;
